<?php /** Configuration file; f0ska xCRUD v.1.6.21; 06/2014 */
    if (file_exists('../../include/conf/env.php')) require_once('../../include/conf/env.php');
    if (file_exists('../include/conf/env.php')) require_once('../include/conf/env.php');;
    if (file_exists('/include/conf/env.php')) require_once('/include/conf/env.php');
    if (file_exists('include/conf/env.php')) require_once('include/conf/env.php');;
...
class Xcrud_config
{
    ...
    public static $dbpass = DB_PASS; // // Your database password
    ...
    public static $language = 'rs'; // sets default localization
    ...
    public static $editor_init_url = 'editors/tinymce/init.js'; //  URL path to your custom initialization file for editor.
    ...
    public static $upload_folder_def = '../../upload/image'; // Default uploads folder on your site, relative to xCRUD folder or absolute path required. Folder is must exist.

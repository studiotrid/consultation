...
class Translate {
	...
	private function setLang() {
		...
		if ( !empty($_GET['language']) ) :
			...
			if ( $this->displayName($lang) ) :
				$this->lang = $lang;
				$_SESSION['loggedUser']['language'] = $lang;
			endif;

		endif;

		$this->lang = !empty($_SESSION['loggedUser']['language']) ? $_SESSION['loggedUser']['language'] : $this->lang;
	...
	public function languageSelector() {
		...
		echo '<select name="languageSelect" id="languageSelect" class="languageSelect" ONCHANGE="location=\'?language=\'+this.options[this.selectedIndex].value;">';

		foreach ( $options as $code => $language ) {

			$selected = ( !empty($_SESSION['loggedUser']['language']) && $_SESSION['loggedUser']['language'] == $code ) ? 'selected="selected"' : '';

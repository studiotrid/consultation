...
class PHPLogin_upgrade extends Generic {
	 ...
	 */
	private function loggedUser_upgrade() {
	...
	private function upgrade_250() {
		...
		parent::query("
			...
			('email-activate-subj', 'You''ve activated your account at loggedUser !'),
			('email-activate-resend-subj', 'Here''s your activation link again for loggedUser'),
			('email-activate-resend-msg', 'Why hello, {{full_name}}. \r\n\r\nI believe you requested this:\r\n{{activate}}\r\n\r\nClick the link above to activate your account :)'),
			('email-welcome-subj', 'Thanks for signing up with loggedUser :)'),
			('email-forgot-success-subj', 'Your password has been reset at loggedUser'),
			...
			('email-forgot-subj', 'Lost your password at loggedUser?'),
			('email-forgot-msg', 'Hi {{full_name}},\r\n\r\nYour username is <strong>{{username}}</strong>.\r\n\r\nTo reset your password at loggedUser, please click the following password reset link:\r\n{{reset}}\r\n\r\nSee you soon!'),
			('email-add-user-subj', 'You''re registered with loggedUser !'),

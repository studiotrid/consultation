...
include_once(ROOT.'login/admin/classes/edit_user.class.php');
			...
			<div class="tab-pane fade in active" id="usr-control">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<span class="uneditable-input"><?php echo SITE_PATH . '?login=admin/profile.php&uid=' . $edituser->getField('user_id'); ?></span>
							</div>
						</div>
						<?php endif; ?>

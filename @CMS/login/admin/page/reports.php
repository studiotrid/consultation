<?php include_once(ROOT.'login/admin/page/admin.php'); ?>
<div id="message">
	<script src="<?=ADMIN_URL;?>/login/admin/assets/js/jquery.flot.min.js"></script>
	<script src="<?=ADMIN_URL;?>/login/admin/assets/js/jquery.flot.resize.min.js"></script>
	<?php include_once(ROOT.'login/admin/page/admin.php'); ?>
	<?php include_once(ROOT.'login/admin/classes/reports.class.php'); ?>
	<fieldset>
	...
	<form method="post" action="?login=admin/page/reports.php" id="reports-date-form" class="form-inline">

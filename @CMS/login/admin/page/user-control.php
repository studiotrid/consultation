...
<fieldset>
	...
	<form method="post" id="search-users-form" action="?login=admin/classes/add_user.class.php" class="pull-right">
	...
	<div id="add_user" class="hide">
		<?php include_once(ROOT.'login/admin/page/user-add.php'); ?>
	</div>
...
$('#showUsers').blur(function() {
	$.post('<?=ADMIN_URL;?>/login/admin/classes/functions.php', {'showUsers' : $(this).val()});

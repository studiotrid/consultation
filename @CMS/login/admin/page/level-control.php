...
<fieldset>
	<legend><?php _e('Modify levels'); ?>
		...
		<form method="post" id="search-levels-form" class="pull-right" action="?login=admin/classes/add_level.class.php">
	...
	<div id="create_level" class="hide">
		<?php include_once(ROOT.'login/admin/page/level-create.php'); ?>
	</div>
...
$('#showLevels').blur(function() {
	$.post('<?=ADMIN_URL;?>login/admin/classes/functions.php', {'showLevels' : $(this).val()});

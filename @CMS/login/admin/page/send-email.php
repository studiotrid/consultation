...
<?php include_once(ROOT.'login/admin/classes/send_email.class.php'); ?>
<fieldset>
	<form method="post" class="form form-horizontal" action="?login=admin/page/send-email.php" id="send-email-form">

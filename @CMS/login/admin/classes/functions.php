...
function displayUsers($row) {
	...
	?>
	<tr>
		<td><a href="?login=admin/users.php&uid=<?php echo $row['user_id']; ?>"><?php echo $generic->get_gravatar($email, true, 20, 'mm', 'g', array('style' => '1')); ?> <?php echo $row['username']; ?></a><?php echo $admin . $restrict; ?></td>
...
function user_levels() {
	...
	?><table class='table'>
			...
			?>
				...
				<tr>
					<td><a href="?login=admin/levels.php&lid=<?php echo $lid; ?>"><?php echo $row['level_name']; ?></a><?php echo $status; ?></td>

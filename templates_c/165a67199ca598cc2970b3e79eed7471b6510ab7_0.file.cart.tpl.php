...
function content_69b2c0967b6086_52194899 (Smarty_Internal_Template $_smarty_tpl) {
...
while ($_block_repeat) {
ob_start();?>Click to view Natal Chart<?php $_block_repeat=false;
...
echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>NATAL CHART<?php $_block_repeat=false;
echo smarty_block_t(array(), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}

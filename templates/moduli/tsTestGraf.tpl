{* Template za prikaz jednog TS testa - predtest grafikon *}
<div class="ts-predtest-grafikon">
    <h4 class="ts-test-subtitle">{t}Pre-test{/t} - {$tsTest.vreme|date_format:"%d.%m.%Y"}</h4>

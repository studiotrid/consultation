...
# Update Author: Justin Anderson
# Web: http://www.ricocheting.com/
# Update: 2018-10-30
# Version: 3.5 (MySQLi)
# Copyright 2018 ricocheting.com
...
class Database {
	...
	public function query($sql){
		...
		if ($this->query_id===false){
			...
			return 0;//legacy leaving it as zero. but should just let function return $this->query_id which would be false
		}
	...
	public function fetch($query_id=false){
		...
		if ($this->query_id!==false){
			...
			$this->oops("Invalid query. Records could not be fetched.");
		}
	...
	private function free_result($query_id=false){
		...
		@mysqli_free_result($this->query_id);//unlike mysql_free_result which returned a success bool, mysqli_free_result returns no value

		$this->query_id=false;//default value
	}#-#free_result()
